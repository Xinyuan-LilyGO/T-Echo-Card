...
if __name__ == "__main__":
    # 设置源文件夹路径和目标文件夹路径
    source_path_1 = [
        r"boards\\lilygo_t_echo_card_nrf52840.json",
    ]
    source_path_2 = [
        r"bootloader\\t_echo_card_nrf52840",
    ]
    source_path_3 = [
        r"variants\\t_echo_card_nrf52840",
    ]
    ...
    if Installation_judgment == False:
        print("\nt-echo-card board installation failed")
    else:
        print("\nt-echo-card board installation successful")
